	...
	var Slider = function (_React$Component) {
	  ...
	  Slider.prototype.render = function render() {
	    ...
	    if (settings.padSlides) {
	      var numberToPad = children.length % settings.slidesToShow == 0 ? 0 : settings.slidesToShow - children.length % settings.slidesToShow;
	      var paddingSlides = [];
	      for (var i = numberToPad; i >= 1; i--) {
	        paddingSlides.push(_react2.default.createElement('div', { key: 'paddingSlide-' + i }));
	      }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getTrackCSS = exports.getTrackCSS = function getTrackCSS(spec) {
	  checkSpecKeys(spec, ['left', 'variableWidth', 'slideCount', 'slidesToShow', 'slideWidth', 'infinite']);
	...
	var helpers = {
	  initialize: function initialize(props) {
	    ...
	    if (!props.vertical) {
	      ...
	      slideWidth = (this.getWidth(_reactDom2.default.findDOMNode(this.list)) - centerPaddingAdj) / props.slidesToShow;
	    } else {
	      slideWidth = this.getWidth(_reactDom2.default.findDOMNode(this.list));
	    }
	...
	var PrevArrow = exports.PrevArrow = function (_React$Component) {
	  ...
	  PrevArrow.prototype.render = function render() {
	    ...
	    if (this.props.prevArrow) {
	      prevArrow = _react2.default.createElement(this.props.prevArrow, _extends({}, prevArrowProps, customProps));
	    } else {
	...
	var NextArrow = exports.NextArrow = function (_React$Component2) {
	  ...
	  NextArrow.prototype.render = function render() {
	    ...
	    if (this.props.nextArrow) {
	      nextArrow = _react2.default.createElement(this.props.nextArrow, _extends({}, nextArrowProps, customProps));
	    } else {
